...
export default function OrganisationsRoutePage() {
  return (
    <RouteShell
      ...
      hideStickyCta
    >
      <section className="bg-[radial-gradient(circle_at_top_left,#e3d6ff_0%,#f4f8ff_40%,#ffffff_100%)] border-b border-purple-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
          ...
          <h1 className="mt-6 text-4xl md:text-5xl text-purple-900 max-w-4xl">
            Un flux B2B dedie pour cadrer vos besoins et accelerer la decision.
          </h1>
          <p className="mt-5 text-lg text-purple-700 max-w-3xl">
            Cette page est dediee aux demandes de proposition des grands comptes:
      ...
      <RevealOnScroll delayMs={40}>
        <RFPForm heading="Demander une proposition B2B" />
      </RevealOnScroll>

      <RevealOnScroll delayMs={80}>
        <DomainsSection
          title="Domaines mobilisables pour votre organisation"
          subtitle="Selectionnez le domaine le plus pertinent dans votre demande de proposition."
