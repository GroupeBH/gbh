...
export function Hero({ onRequestProposal, onBookAppointment }: HeroProps) {
  return (
    <section className="relative overflow-hidden border-b border-purple-200/50 bg-[linear-gradient(140deg,#f7f1ff_0%,#f6f9ff_45%,#ece4ff_100%)]">
      ...
      <div className="pointer-events-none absolute -left-20 top-16 h-64 w-64 rounded-full bg-purple-400/25 blur-3xl" />
      <div className="pointer-events-none absolute -right-20 top-0 h-80 w-80 rounded-full bg-cyan-300/30 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 left-1/3 h-64 w-64 rounded-full bg-fuchsia-300/20 blur-3xl" />
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              >
                Demander une proposition (B2B)
              </Button>
              <Button
                onClick={onBookAppointment}
                size="lg"
                variant="outline"
                className="rounded-full border-purple-400 bg-white/70 text-purple-800 hover:bg-white px-8"
              >
                Prendre rendez-vous
              </Button>
            </div>
          ...
          <div className="relative rounded-3xl border border-purple-200 bg-white/75 p-8 shadow-[0_20px_44px_rgba(58,23,143,0.18)] backdrop-blur">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <article className="rounded-2xl bg-[linear-gradient(135deg,#2b1464,#6f31ef)] p-5 text-white shadow-[0_10px_24px_rgba(71,31,172,0.35)]">
              ...
              <article className="rounded-2xl border border-purple-200 bg-purple-50/70 p-5">
              ...
              <article className="rounded-2xl border border-purple-200 bg-cyan-50/70 p-5">
                <p className="text-sm uppercase tracking-[0.18em] text-purple-600">
                  Reporting
                </p>
